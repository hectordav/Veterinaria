...
class Push_cli {
    ...
    public function __construct() {
        ...
        $this->ionicProfile ='taxsicliente';
        /* se saca del apikey settings/ApiKeys*/
        $this->ionicAPIToken ='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJiMDdhMGYwZS04MzJiLTRlMGUtOTdlNi1lMWJjYTMyZjEwODYifQ.k8hqABbznBCbaeqngrFrB-cykEIYTtd2po2GzigtClk';
    }
    /**
     * 
