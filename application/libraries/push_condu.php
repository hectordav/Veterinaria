...
class Push_condu {
    ...
    public function __construct() {
        /*el certficado que se crea en settings/certificates (el tag)*/
        $this->ionicProfile ='taxsiconductor';
        /* se saca del apikey settings/ApiKeys*/
        $this->ionicAPIToken ='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiIwMzY0NDhiZS0yNzFlLTQ1ZjYtOWRkOC02NmU1ODNhZmI1MDUifQ.vicxFxJMXj7LUWwo-tWlFvqcg7F8ydIq_FSXjzq2TKs';
    }
    /**
     * 
